...
//        [self.mainViewController updateWeather];
...
- (void)applicationWillTerminate:(UIApplication *)application {
    ...
    ZMBWeatherModel *myWeatherModel = [ZMBNetworkController sharedController].weatherModel;
    
    NSUserDefaults *myUserDefaults = [NSUserDefaults standardUserDefaults];
    [myUserDefaults setObject:myWeatherModel forKey:@"myWeatherModel"];
    
    NSDate *timeAppClosed = [NSDate date];
    [myUserDefaults setObject:timeAppClosed forKey:@"timeAppClosed"];
